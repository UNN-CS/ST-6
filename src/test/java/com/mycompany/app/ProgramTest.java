...
public class ProgramTest {
    ...
    //=== checkState PLAYING vs DRAW vs XWIN vs OWIN ===
    ...
    //=== MiniMax, MinMove, MaxMove return within bounds ===
    ...
    //=== Utility.print overloads just run without exception ===
    ...
    //=== Program.main (headless) ===

    @Test
    public void testProgramMainHeadless() throws Exception {
        System.setProperty("java.awt.headless", "true");
        Program.main(new String[0]);
    }

    //=== TicTacToeCell getters/setMarker ===
